...
CREATE TABLE Users (id SERIAL PRIMARY KEY, username TEXT, password TEXT,admin INTEGER, pic_id INTEGER REFERENCES Pictures, online INTEGER);
CREATE TABLE Topics (id SERIAL PRIMARY KEY, user_id INTEGER REFERENCES Users, topic TEXT, info TEXT, time TIMESTAMP, pic_id INTEGER REFERENCES Pictures);
